...
This repository contains the code used for the [Thorlabs Insight covering the design and build of an imaging, tracking solar telescope using the PRMTZ8 rotation stages](https://youtu.be/4gaVIQsGUl4). This Insight provides a overall explanation the the telescope design and using the software. 
